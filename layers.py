...
class Layers:
    ...
    def inference0(self, input_x, reuse=False):
    ...
    def ladder0(self, input_x, reuse=False):
    ...
    def inference1(self, latent1, reuse=False):
    ...
    def ladder1(self, latent1, reuse=False):
    ...
    def ladder2(self, latent1, reuse=False):
        ...
        with tf.variable_scope("generative0") as gs:
            ...
            if ladder0 is not None:
                ...
                if latent1 is not None:
                    latent1 = tf.concat(1, [latent1, ladder0])
                else:
                    latent1 = ladder0
        ...
        with tf.variable_scope("generative1") as gs:
            ...
            if ladder1 is not None:
                ...
                if latent2 is not None:
                    latent2 = tf.concat(1, [latent2, ladder1])
                else:
                    latent2 = ladder1
